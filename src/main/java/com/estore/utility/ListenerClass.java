...
public class ListenerClass extends ExtentManager implements ITestListener {
	...
	public void onStart(ITestContext arg0) {
		File sourceFile = new File(System.getProperty("user.dir") + "\\test-output\\extentreport\\CurrentTestResults\\"
				+ "ExtentReport.html");
		if (sourceFile.exists()) {
			...
			File dir = new File(
					System.getProperty("user.dir") + "\\test-output\\extentreport\\ArchivedTestResults\\" + foldername);
			dir.mkdir();
			...
			try {
				...
				test.log(Status.FAIL,
						MarkupHelper.createLabel(
								...
								ExtentColor.RED));
				String imgPath = Action.takeScreenShot(BaseClass.getDriver(), result.getName().toString(),
