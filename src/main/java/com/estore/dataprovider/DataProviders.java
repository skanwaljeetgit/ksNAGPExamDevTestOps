...
import com.estore.utility.NewExcelLibrary;
...
public class DataProviders {
	...
	// get data from ExpectedUrl sheet
	@DataProvider(name = "getUrl")
	public Object[][] getUrl() throws EncryptedDocumentException, IOException {
		return excelLibrary.getData("ExpectedUrl");
	}
